...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch("https://village-backend-16uk.onrender.com/login", {
        method: "POST",
        headers: {
...
>
  {showPassword ? <EyeOff size={20} /> : <Eye size={20} />}
          ...
          <p style={styles.registerText}>
            ...
            <Link to="/register" style={{ color: "black", textDecoration: "none", fontWeight: "bold" }}> Register Now</Link>
          </p>
          <p style={styles.orText}>
            <b>Login with others</b>
          </p>
